const findDuplicateTransactions = require("./solution");
...
describe("findDuplicateTransactions()", function() {
  ...
  it("returns find duplicate transactions and remove them test transactions", function() {
    assert.deepEqual(findDuplicateTransactions(testData), testDataExpectedOutput);
  });
  it("returns find duplicate transactions and remove them real transactions", function() {
    assert.deepEqual(findDuplicateTransactions(realData), realDataExpectedOutput);
  });
  // add your tests here
});
